...
<head>
	...
	<link rel="stylesheet" href="stylgalerii.css" type="text/css" />
...
<body>
	...
	<div id="container">
		...
		<div id="sidebar" style="height: 1005px;">
		...
		<span class="bigtitle">Galeria zdjęć</span>
	...
	?>
      ...
      <div class="transparent-box">
        <div class="caption">
          <p>Biblioteka</p>
          <p class="opacity-low">Architektura</p>
        </div>
      </div> 
    </div>
				<div class="img-box">
    ...
    <div class="img-box">
      ...
      <div class="transparent-box">
        <div class="caption">
          <p>Kawusia</p>
          <p class="opacity-low">Mmm jaka pyszna</p>
        </div>
      </div>
    </div>
  </div>
